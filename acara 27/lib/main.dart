...
class _HomeState extends State<Home> {
  ...
  String _agama = "Kristen Protestan";
  String _jk = "";
      ...
      content: new Container(
        ...
        child: new Column(
          children: <Widget>[
            ...
            new Text("Moto Hidup : ${controllerMoto}"),
  ...
  Widget build(BuildContext contextS) {
    return new Scaffold(
        appBar: new AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 87, 181, 236),
        ),
        body: new ListView(
          children: [
            new Container(
              ...
              child: new Column(
                children: <Widget>[
                  ...
                  new RadioListTile(
                    ...
                    subtitle: new Text("Pilih ini jika anda laki-aki"),
                  ),
                  new RadioListTile(
                    value: "perempuan",
                  ...
                  new RaisedButton(
                      child: new Text("OK"),
                      color: Color.fromARGB(255, 86, 175, 248),
                      onPressed: () {
                        kirimdata();
                      })
                ],
